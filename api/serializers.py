...
from api.models import User, Etudiant, Scolarite
...
# ===================================================================
# 2. ETUDIANT SERIALIZER (avec validation et mise à jour)
# ===================================================================
...
# ===================================================================
# 3. SCOLARITE SERIALIZER (avec validation et mise à jour)
# ===================================================================
class ScolariteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Créer le profil scolarité
        scolarite = Scolarite.objects.create(user=user, **validated_data)
        return scolarite
